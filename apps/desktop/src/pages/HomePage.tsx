...
import { LayoutGrid, List, ChevronLeft, ChevronRight, Search, Heart, Clock, ChevronRight as ChevronRightIcon, Columns3 } from 'lucide-react';
                ...
                <div className="relative" ref={columnsMenuRef}>
                  ...
                  {showColumnsMenu && (
                    <div className="absolute right-0 top-full mt-1 z-50 w-56 bg-card border border-border rounded-lg shadow-lg p-2 max-h-[400px] overflow-y-auto">
                      {allColumns
                        .filter((col) => !(col.id === 'episodes' && activeType === 'MOVIE'))
                        .map((col) => {
                ...
                <thead className="bg-secondary/50">
                  <tr>
                    {allColumns
                      ...
                      .filter((c) => !(c.id === 'episodes' && activeType === 'MOVIE'))
                      .map((col) => (
